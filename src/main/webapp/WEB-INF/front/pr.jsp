	 	...
	 	<div class="sub_container">
	 		<div class="sub_top_box">
		 		...
		 		<div class="sub_search_box">
		 			<div class="select_box">
                        <P class="lato">All</P>
                        <img src="/img/sub/pr/select-down2.png" alt="셀리버리L&H" class="pc-ver">
                        <img src="/img/sub/pr/select-down2-m.png" alt="셀리버리L&H" class="mo-ver">     
                        <ul>
                            <li><a href="">All</a></li>
                            <li><a href="">셀리버리L&H</a></li>
                            <li><a href="">더라퓨즈</a></li>
                            <li><a href="">바이오늘</a></li>
						</ul>
                    </div>
                   <form id="new_search" class="search" name="search_form" method="post" enctype="">
                    	...
                    	<button type="submit">
                    		<img src="/img/sub/pr/board-search.png" alt="셀리버리L&H" class="pc-ver">
                    		<img src="/img/sub/pr/board-search-m.png" alt="셀리버리L&H" class="mo-ver">
                    	</button>
	 		...
	 		<div class="news_table">
		 		<div class="th_line">
		 			...
		 			<div class="audivor">작성자</div>
		 			<div class="date">작성일</div>
		 		</div>
		 		<div class="notice_line">
		 			<div class="num">공지</div>
		 			<div class="subject"><a href="javascript:alert('준비중입니다')">[바이오늘] 셀리버리 리빙앤헬스, 바이오케어 티슈 브랜드 ‘바이오;늘~’ 론칭 </a></div>
		 			<div class="author">셀리버리L&amp;H</div>
