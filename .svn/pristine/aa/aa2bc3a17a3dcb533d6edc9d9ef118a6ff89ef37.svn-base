	 ...
	 <div class="sub_content">
	 	<div class="sub_container">
	 		<div class="board-view-content">
	 			<h5 class="board-view-tit">[공지사항] 대표이사 주식취득에 의한 주식 소유상황 변동 안내 공지</h5>
	 			<div class="board-view-con">
	 				<img src="/img/sub/pr/board-view-con-ex.jpg" alt="셀리버리L&H">
	 				<br/>
	 				<p>안녕하세요. 셀리버리 L&H입니다. <br/>
					대표이사 주식취득에 의한 주식 소유상황 변동 안내 공지드립니다.</p>
	 				
	 			</div>
	 		</div>
	 		<div class="board-button-wrap">
	 			<a href="#"><img src="/img/sub/pr/board-list.png" alt="셀리버리L&H"><span class="lato">GO TO THE LIST</span></a>
	 		</div>
